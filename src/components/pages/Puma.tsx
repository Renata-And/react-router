...
import pumaModel2
    from '../../assets/puma-2.webp';
import pumaModel3 from '../../assets/puma-3.webp';
...
export const pumaArr:PumaItem[] = [
    {
        id: 4,
        model: 'Unisex Puma Slipstream Expedition',
        collection: 'new 1111',
        price: '100500$',
        picture: pumaModel1,
    ...
    {
        id: 5,
        model: 'Sneaker Unisex Puma Rs-X',
        collection: 'new 2222',
        price: '200700$',
        picture: pumaModel2,
    },
    ...
    return (
      <div>
          ...
          <div style={{display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap'}}>
              {pumaArr.map((el, i) => {
                  return <Link key={i} to={`/puma/${el.id}`}>
